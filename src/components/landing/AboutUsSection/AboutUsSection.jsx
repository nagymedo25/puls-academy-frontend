...
const strengths = [
  {
    ...
    description:
      "نقدم لك محتوى تعليمياً أعده نخبة من الخبراء، يتم تحديثه باستمرار ليواكب أحدث المناهج والتطورات العلمية.",
  },
  {
    ...
    description:
      "فيديوهات عالية الجودة، وشروحات عملية تركز على التطبيق، مصممة لتجعل رحلتك التعليمية ممتعة وفعالة.",
  },
  {
    ...
    description:
      "فريق دعم فني وأكاديمي متخصص جاهز للإجابة على استفساراتك وحل أي مشكلة قد تواجهك في أسرع وقت.",
  },
  {
    ...
    description:
      "تعلم في أي وقت ومن أي مكان. منصتنا متوافقة مع جميع الأجهزة لتمنحك حرية كاملة في تنظيم وقتك.",
  },
];
    ...
    >
      <Container maxWidth="lg">
        <Box sx={{ textAlign: "center", mb: 10 }}>
          ...
          >
            في Pulse Academy، نحن لا نقدم كورسات فحسب، بل نبني جسرًا بين المعرفة
            الأكاديمية والتطبيق العملي. مهمتنا هي تمكين طلاب الصيدلة وطب الاسنان
            بجامعة الازهر بالمهارات والشروحات التي يحتاجونها للنجاح في دراستهم
            ومسيرتهم المهنية.
          </Typography>
        </Box>
            ...
            <Grid item xs={12} sm={6} md={6} key={strength.id}>
              <Paper
                ...
                sx={{
                  ...
                  transition:
                    "transform 0.4s ease-in-out, box-shadow 0.4s ease-in-out, background-color 0.4s ease",
                  ...
                  "&:hover": {
                    ...
                    boxShadow: (theme) =>
                      `0 25px 50px -12px ${theme.palette.primary.main}33`,
                  },
                  "&::after": {
                    content: '""',
                    position: "absolute",
                    ...
                    borderRadius: "50%",
                    boxShadow: (theme) =>
                      `0 0 10px 2px white, 0 0 20px 4px ${theme.palette.primary.light}, 0 0 30px 6px ${theme.palette.primary.main}`,
